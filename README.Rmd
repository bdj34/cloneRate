...
Let's now look at the specific clone represented by node 85 (shaded in red), which we know corresponds to a clone with a JAK2 and DNMT3A mutation, based on the annotation in [Williams et al. Fig. 3](https://www.nature.com/articles/s41586-021-04312-6)
