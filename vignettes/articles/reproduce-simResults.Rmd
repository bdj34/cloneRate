...
preprint.](https://www.biorxiv.org/) We'll reproduce this validation
here.
...
```{r vary_n}
n10_n30_trees <- simUltra(a = a_vec, b= b_vec, cloneAge = 20, n = n_vec, 
                          nTrees = length(n_vec))
```
...
ggplot(results_vary_n) +
  ...
  xlab("Net growth rate estimate (r)") +
  ylab("Density") +
  scale_color_manual(labels = c("Internal lengths", "Max. likelihood"), 
...
preprint](https://www.biorxiv.org/). This information is also available
...
and 4 of [our preprint](https://www.biorxiv.org/), noting that our
...
preprint](https://www.biorxiv.org/). Here, we have two options:
...
And here's a final link to [our paper](https://www.biorxiv.org/) for
