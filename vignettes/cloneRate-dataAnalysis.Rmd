...
recent preprint](https://www.biorxiv.org/content/10.1101/2023.02.24.529817v1/) analyzing single-cell Whole Genome Sequencing 
...
Here, we recreate the analysis in [Figure 5E-G of our work](https://www.biorxiv.org/content/10.1101/2023.02.24.529817v1/).
...
Now, let's take the mean for each individual and re-create [Fig. 5E](https://www.biorxiv.org/content/10.1101/2023.02.24.529817v1/).
...
### Time from clone initiation to diagnosis ([Fig. 5G](https://www.biorxiv.org/content/10.1101/2023.02.24.529817v1/))
...
We see that in 15/19 cases, the youngest clone (with >= 10 tips)  is also the most fit. First, let's use the most fit clones and stratify by the mean, reproducing [our result in Figure 5G.](https://www.biorxiv.org/content/10.1101/2023.02.24.529817v1/)
...
Let's now fit a logistic curve to the longitudinal data and estimate the growth rate for one of these clones, from individual PD9478, which is the tree we showed at the beginning of this vignette. Here, we are recreating some of the analysis from [our Figure 6.](https://www.biorxiv.org/content/10.1101/2023.02.24.529817v1/)
...
All in all, not too bad! For now, we'll leave the others for you to explore. This vignette has already been a bit long. But now you should have the tools to reproduce our analysis relating to the real data aspect of [our paper](https://www.biorxiv.org/content/10.1101/2023.02.24.529817v1/). Hopefully you were able to do this in minutes and hours, which is much better than the months it took me!
...
And here's a final link to [our paper](https://www.biorxiv.org/content/10.1101/2023.02.24.529817v1/) for more of the details of the methods and data analysis.
