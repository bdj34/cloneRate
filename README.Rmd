...
As a bonus, we provide a fast way to simulate the coalescent (tree) of a sample from a birth-death branching tree. A direct result of [Amaury Lambert's work](https://pubmed.ncbi.nlm.nih.gov/29704514/), we use this fast simulation technique to validate our growth rate estimates.
