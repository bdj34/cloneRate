...
As a bonus, we provide a fast way to simulate the coalescent (tree) of a sample from a birth-death branching process. A direct result of [Amaury Lambert's work](https://pubmed.ncbi.nlm.nih.gov/29704514/), we use this fast simulation technique to validate our growth rate estimates.
...
For this basic tutorial and our vignettes, we will also use a few other packages, 
which can all be installed from CRAN. Because these are listed as packages we suggest, 
running the above command (setting "dependencies = TRUE") will install them along
with the vignettes.
